...
| `code` | FHIR | yes | Bare LOINC code. P3.S1 accepts `79560-9` (stoma output) and `9000-1` (oral fluid intake); other codes are `UNSUPPORTED_CODE` until their sprint lands. Widening the accepted set is additive under §8. |
